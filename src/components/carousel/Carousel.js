                ...
                <Carousel className={classes.carousel} dynamicHeight infiniteLoop={true} interval={6000} useKeyboardArrows={true} transitionTime={1700} emulateTouch showArrows={false} autoPlay showStatus={false} showThumbs={false} >
                    ...
                    <div className={classes.image_container} >
                        ...
                        <div className='legend'>
                            ...
                            <a href="https://docs.google.com/document/d/1LzC8K7S5_tfPeeGW0g5P7JBdWJ840_F3v6URFlCFJhI/edit?usp=sharing" rel="opener noreferrer" target="_blank">View Resume   <FaArrowCircleDown /></a>
                        </div>
                    </div>
                    
                    <div className={classes.image_container}>
                        <img className={classes.image} src={water} alt="myImage" />
                        <div className='legend'>
